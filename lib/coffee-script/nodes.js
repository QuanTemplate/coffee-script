// Generated by CoffeeScript 1.7.1-qt3
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, Finalise, For, HEXNUM, IDENTIFIER, IDENTIFIER_STR, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isLiteralArguments, isLiteralThis, last, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1,
    __finalise = function(ctor, name) { return ctor.__finalise__ ? ctor.__finalise__(name) : ctor; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent, name) { if(parent.__extends__) return parent.__extends__(child, name); for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  ...
  exports.CodeFragment = CodeFragment = (function() {
    ...
    return __finalise(CodeFragment, "CodeFragment");
  ...
  exports.Base = Base = (function() {
    ...
    return __finalise(Base, "Base");

  })();

  exports.Block = Block = (function(_super) {
    __extends(Block, _super, "Block");
    ...
    return __finalise(Block, "Block");

  })(Base);

  exports.Literal = Literal = (function(_super) {
    __extends(Literal, _super, "Literal");
    ...
    return __finalise(Literal, "Literal");

  })(Base);

  exports.Undefined = (function(_super) {
    __extends(Undefined, _super, "Undefined");
    ...
    return __finalise(Undefined, "Undefined");

  })(Base);

  exports.Null = (function(_super) {
    __extends(Null, _super, "Null");
    ...
    return __finalise(Null, "Null");

  })(Base);

  exports.Bool = (function(_super) {
    __extends(Bool, _super, "Bool");
    ...
    return __finalise(Bool, "Bool");

  })(Base);

  exports.Return = Return = (function(_super) {
    __extends(Return, _super, "Return");
    ...
    return __finalise(Return, "Return");

  })(Base);

  exports.Value = Value = (function(_super) {
    __extends(Value, _super, "Value");
    ...
    return __finalise(Value, "Value");

  })(Base);

  exports.Comment = Comment = (function(_super) {
    __extends(Comment, _super, "Comment");
    ...
    return __finalise(Comment, "Comment");

  })(Base);

  exports.Call = Call = (function(_super) {
    __extends(Call, _super, "Call");
    ...
    return __finalise(Call, "Call");

  })(Base);

  exports.Extends = Extends = (function(_super) {
    __extends(Extends, _super, "Extends");

    function Extends(child, parent, className) {
      this.child = child;
      this.parent = parent;
    ...
    Extends.prototype.compileToFragments = function(o) {
      var name;
      name = new Literal("\"" + this.className + "\"");
      return new Call(new Value(new Literal(utility('extends'))), [this.child, this.parent, name]).compileToFragments(o);
    };

    return __finalise(Extends, "Extends");

  })(Base);

  exports.Finalise = Finalise = (function(_super) {
    __extends(Finalise, _super, "Finalise");

    function Finalise(child, className) {
      this.child = child;
      this.className = className;
    }

    Finalise.prototype.children = ['child'];

    Finalise.prototype.compileToFragments = function(o) {
      var name;
      name = new Literal("\"" + this.className + "\"");
      return new Call(new Value(new Literal(utility('finalise'))), [this.child, name]).compileToFragments(o);
    };

    return __finalise(Finalise, "Finalise");

  })(Base);

  exports.Access = Access = (function(_super) {
    __extends(Access, _super, "Access");
    ...
    return __finalise(Access, "Access");

  })(Base);

  exports.Index = Index = (function(_super) {
    __extends(Index, _super, "Index");
    ...
    return __finalise(Index, "Index");

  })(Base);

  exports.Range = Range = (function(_super) {
    __extends(Range, _super, "Range");
    ...
    return __finalise(Range, "Range");

  })(Base);

  exports.Slice = Slice = (function(_super) {
    __extends(Slice, _super, "Slice");
    ...
    return __finalise(Slice, "Slice");

  })(Base);

  exports.Obj = Obj = (function(_super) {
    __extends(Obj, _super, "Obj");
    ...
    return __finalise(Obj, "Obj");

  })(Base);

  exports.Arr = Arr = (function(_super) {
    __extends(Arr, _super, "Arr");
    ...
    return __finalise(Arr, "Arr");

  })(Base);

  exports.Class = Class = (function(_super) {
    __extends(Class, _super, "Class");
    ...
    Class.prototype.hoistMetaclassDeclaration = function(ctorName) {
      var base, ctorBase, declIndex, expressions, index, metaclassAccess, node, prop0, _i, _len;
      expressions = this.body.expressions;
      declIndex = null;
      for (index = _i = 0, _len = expressions.length; _i < _len; index = ++_i) {
        node = expressions[index];
        if (node instanceof Assign && node.variable instanceof Value) {
          ctorBase = (base = node.variable.base) instanceof Literal && base.value === ctorName;
          metaclassAccess = (prop0 = node.variable.properties[0]) instanceof Access && prop0.name instanceof Literal && prop0.name.value === "__metaclass__";
          if (ctorBase && metaclassAccess) {
            declIndex = index;
            break;
          }
        }
    ...
    Class.prototype.compileNode = function(o) {
      ...
      this.hoistMetaclassDeclaration(name);
      this.addBoundFunctions(o);
      this.body.spaced = true;
      this.body.expressions.push(new Finalise(lname, name));
      if (this.parent) {
        superClass = new Literal(o.classScope.freeVariable('super', false));
        this.body.expressions.unshift(new Extends(lname, superClass, name));
    ...
    return __finalise(Class, "Class");

  })(Base);

  exports.Assign = Assign = (function(_super) {
    __extends(Assign, _super, "Assign");
    ...
    return __finalise(Assign, "Assign");

  })(Base);

  exports.Code = Code = (function(_super) {
    __extends(Code, _super, "Code");
    ...
    return __finalise(Code, "Code");

  })(Base);

  exports.Param = Param = (function(_super) {
    __extends(Param, _super, "Param");
    ...
    return __finalise(Param, "Param");

  })(Base);

  exports.Splat = Splat = (function(_super) {
    __extends(Splat, _super, "Splat");
    ...
    return __finalise(Splat, "Splat");

  })(Base);

  exports.Expansion = Expansion = (function(_super) {
    __extends(Expansion, _super, "Expansion");
    ...
    return __finalise(Expansion, "Expansion");

  })(Base);

  exports.While = While = (function(_super) {
    __extends(While, _super, "While");
  ...
  exports.Op = Op = (function(_super) {
    ...
    return __finalise(Op, "Op");

  })(Base);

  exports.In = In = (function(_super) {
    __extends(In, _super, "In");
    ...
    return __finalise(In, "In");

  })(Base);

  exports.Try = Try = (function(_super) {
    __extends(Try, _super, "Try");
    ...
    return __finalise(Try, "Try");

  })(Base);

  exports.Throw = Throw = (function(_super) {
    __extends(Throw, _super, "Throw");
    ...
    return __finalise(Throw, "Throw");

  })(Base);

  exports.Existence = Existence = (function(_super) {
    __extends(Existence, _super, "Existence");
    ...
    return __finalise(Existence, "Existence");

  })(Base);

  exports.Parens = Parens = (function(_super) {
    __extends(Parens, _super, "Parens");
    ...
    return __finalise(Parens, "Parens");

  })(Base);

  exports.For = For = (function(_super) {
    __extends(For, _super, "For");
    ...
    return __finalise(For, "For");

  })(While);

  exports.Switch = Switch = (function(_super) {
    __extends(Switch, _super, "Switch");
    ...
    return __finalise(Switch, "Switch");

  })(Base);

  exports.If = If = (function(_super) {
    __extends(If, _super, "If");
    ...
    return __finalise(If, "If");

  })(Base);

  UTILITIES = {
    "extends": function() {
      return "function(child, parent, name) { if(parent.__extends__) return parent.__extends__(child, name); for (var key in parent) { if (" + (utility('hasProp')) + ".call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; }";
    },
    bind: function() {
    ...
    finalise: function() {
      return "function(ctor, name) { return ctor.__finalise__ ? ctor.__finalise__(name) : ctor; }";
    },
    hasProp: function() {
